...
const SearchPage = () => {
    ...
    const [searchQuery, setSearchQuery] = useState(params.text || "");
        ...
        <div className="max-w-7xl mx-auto my-10">
            <div className="flex flex-col md:flex-row justify-between gap-10">
                ...
                <div className="flex-1">
                    {/* searchQuery, setSearchQuery] = useState(params.text || "");  input field */}
                    ...
                    <div>
                        <div className="flex flex-col gap-3 md:flex-row  md:items-center md:gap-2 my-3 ">
                            ...
                            <div className="flex flex-wrap gap-2 mb-4 md:mb-0" >
                                {
                                    ["Briyani", "momos", "jalebi"].map((selectedFileter: string, idx: number) => (
                                        <div key={idx} className="relative inline-flex items-center max-w-full">
                                            ...
                                            <X
                                                size={16}
                                                className="absolute text-[#D19254] hover:cursor-pointer  right-1"
                                            />
                                        ...
                                        <Card className="bg-white dark:bg-gray-800 shadow-xl  rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                                            ...
                                            <CardContent className="p-4">
                                                ...
                                                <div className="flex gap-2 mt-4 flex-wrap">
                                                    {
                                                        ["Briyani", "momos", "jalebi"].map((cuisine: string, idx: number) => (
                                                            <Badge key={idx} className="font-medium px-2 py-1 rounded-full shadow-sm bg-black text-white" variant="outline">
                                                                {cuisine}
                                                            </Badge>
                                                        ))
                                                    }
